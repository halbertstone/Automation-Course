...
public class HomeForm extends BaseForm {
    ...
    public final Link login = new Link(By.linkText("Войти"), "Login");
    private final Label username = new Label(By.className("user-name"), "Username");
    private final Link catalog = new Link(By.xpath("//nav//a[contains(text(), 'Каталог и цены')]"), "Catalog");
